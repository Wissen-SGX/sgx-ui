      ...
      >
        <div className="p-6 border-b" style={{ borderColor: "#E5E7EB" }}>
          ...
          <p className="text-sm mt-1" style={{ color: "#6B7280" }}>
            {universe.uploadHistory.length} file
            {universe.uploadHistory.length !== 1 ? "s" : ""} uploaded
          </p>
        </div>
              ...
              {universe.uploadHistory.length === 0 ? (
                ...
                universe.uploadHistory.map((upload, index) => (
                  <tr
                    ...
                    style={{
                      borderBottom:
                        index < universe.uploadHistory.length - 1
                          ? "1px solid #E5E7EB"
                          : "none",
                    }}
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        ...
                        style={{
                          backgroundColor:
                            upload.status === "Active" ? "#DCFCE7" : "#F3F4F6",
                          color:
                            upload.status === "Active" ? "#166534" : "#6B7280",
                        }}
                      >
                        {upload.status}
                      </span>
