    ...
    <div>
      ...
      >
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <span
              ...
              style={{
                backgroundColor:
                  universe.type === "Global Universe" ? "#E0F2FE" : "#F0FDF4",
                color:
                  universe.type === "Global Universe" ? "#0369A1" : "#15803D",
              }}
            >
              {universe.type}
            </span>
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: "#0B236B" }}>
              {universe.uploadHistory.find((u) => u.status === "Active")
        ...
        {isGlobalUniverse && (
          <div
            ...
            style={{ backgroundColor: "#FEF3C7", border: "1px solid #FDE047" }}
          >
            <p className="text-sm" style={{ color: "#92400E" }}>
              <strong>Note:</strong> The name of the Global Universe cannot be
              changed. You can only update the description and upload files.
            </p>
          </div>
        )}
      </div>
      ...
      >
        ...
        {selectedFile && (
          ...
          >
            <p className="text-sm" style={{ color: "#92400E" }}>
              <strong>Note:</strong> Uploading a new file will archive the
              current active file and make this new file active.
            </p>
          </div>
        )}
      </div>
