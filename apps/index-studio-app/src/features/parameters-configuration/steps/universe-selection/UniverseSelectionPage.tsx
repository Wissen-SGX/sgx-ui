...
export default function UniverseSelectionPage() {
  ...
  const typeOptions = [
    "All Types",
    ...Array.from(new Set(universes.map((u) => u.type))),
  ];
  ...
  const filteredUniverses = universes.filter((universe) => {
    ...
    return (
      matchesSearch &&
      (selectedType === "All Types" || universe.type === selectedType)
    );
  });
            ...
            <div className="p-6 border-b" style={{ borderColor: "#E5E7EB" }}>
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm" style={{ color: "#6B7280" }}>
                  Showing {filteredUniverses.length} of {universes.length}{" "}
                  records
                </div>
                ...
                <tbody>
                  {filteredUniverses.length === 0 ? (
                    ...
                    filteredUniverses.map((item, index) => {
                      const latestUpload = item.uploadHistory.find(
                        (u) => u.status === "Active",
                      );
                      return (
                        <tr
                          ...
                          style={{
                            borderBottom:
                              index < filteredUniverses.length - 1
                                ? "1px solid #E5E7EB"
                                : "none",
                          }}
                        >
                          ...
                          <td className="px-6 py-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              <button
                                onClick={() =>
                                  navigate(
                                    `/parameters/universe/${item.id}/history`,
                                  )
                                }
                              ...
                              <button
                                onClick={() =>
                                  navigate(
                                    `/parameters/universe/${item.id}/edit`,
                                  )
                                }
                                className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
              ...
              onClick={() => {
                ...
                if (universe) {
                  const confirmed = window.confirm(
                    `Are you sure you want to delete ${universe.universeName}?`,
                  );
