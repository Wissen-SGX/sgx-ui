          ...
          <div className="p-6 border-b" style={{ borderColor: "#E5E7EB" }}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm" style={{ color: "#6B7280" }}>
                Showing {filteredFilterSets.length} of {filterSets.length}{" "}
                records
              </div>
              {searchQuery !== "" && (
                <button
                ...
                {filteredFilterSets.length === 0 ? (
                  <tr>
                    <td colSpan={8} className="px-6 py-12 text-center">
                      <div className="text-sm" style={{ color: "#6B7280" }}>
                        No filter sets match your filters
                      </div>
                    </td>
                  </tr>
                ) : (
                  filteredFilterSets.map((item, index) => (
                    <tr
                      ...
                      style={{
                        borderBottom:
                          index < filteredFilterSets.length - 1
                            ? "1px solid #E5E7EB"
                            : "none",
                      }}
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            onClick={() =>
                              navigate(`/parameters/filtering/${item.id}/view`)
                            }
                          ...
                          <button
                            onClick={() =>
                              navigate("/parameters/filtering/create")
                            }
                            className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
                            title="Edit"
                          >
